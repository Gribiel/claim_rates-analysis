...
claim_datata <- claim_data[,c('id', '年', '月', '轮胎品牌', '轮胎规格', '轮胎花纹',
                            '轮胎层级', '生产月', 'DOT年号', '生产厂')]
...
m <- c("6.50|7.00|7.50|8.25R16|9.00|10.00|11.00|12.00")
...
merge_data <- merge(dat1_2, dat2_2 ,by = c("经过月", "生产日期"), all = TRUE)
